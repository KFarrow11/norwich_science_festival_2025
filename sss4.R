...
super4 <- fluidPage(
  ...
  tags$head(
    tags$style(HTML(" 
      body { 
          background-color: #BDC3CB;  /* Set background color of the body */
          font-family: 'Lucida Sans Typewriter', Monaco, monospace;  /* Set font family for the page */
      }
      .sidebar {
          color: black; /* Set text color to white */
          background-color: #2379EB; /* blue background */
      ...
      .title {
          ...
          background-color: #658EA9;  /* Set background color for the title */
      ...
      .action-button {
          background-color: #FE5303;  /* Set background color for action buttons */
...
super_server4 <- function(input, output, session) {
...
# SHINY APP ----
# Run the Shiny app
shinyApp(ui = super4, server = super_server4)
