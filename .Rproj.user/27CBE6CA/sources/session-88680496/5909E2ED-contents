...
ui_nsf25 <- fluidPage(
    ...
    tags$head(
      ...
      .title {
          ...
          border: 5px solid #52688F;  /* Add border around the title */
          border-radius: 10px;  /* Round corners of the title */
          padding: 10px;  /* Add padding inside the title */
          background-color: #043BB1;  /* Set background color for the title */
      ...
      .action-button {
          background-color: #52688F;  /* Set background color for action buttons */
