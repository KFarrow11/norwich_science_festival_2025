...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      checkboxGroupInput("age", "How old are you?", choices = c("<=5" = "<=5", "6-10" = "6-10", "11-15" = "11-15", "16-19" = "16-19", 
                                                                "20-24" = "20-24", "25-29" = "25-29", "30-39" = "30-39", "40-49" = "40-49", 
                                                                "50-59" = "50-59", "60-69" = "60-69", "70+" = "70+")),  # Age categories
      sliderInput("blocks", "How many blocks?", min = 1, max = 10, value = 1), # Slider input for number of blocks
      checkboxGroupInput("color", "What's your favourite colour?", # Pick a colour from options
