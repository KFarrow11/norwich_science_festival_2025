...
ui_nsf25_2 <- fluidPage(
  ...
  tags$head(
    tags$style(HTML(" 
      ...
      .sidebar {
          background-color: #FFA500;  /* Set background color for sidebar */
      ...
      .title {
          ...
          border: 5px solid black;  /* Add border around the title */
          border-radius: 10px;  /* Round corners of the title */
          padding: 10px;  /* Add padding inside the title */
          background-color: #007600;  /* Set background color for the title */
      ...
      .action-button {
          background-color: #007600;  /* Set background color for action buttons */
  ...
  sidebarLayout(
    sidebarPanel(
      class = "sidebar",
      sliderInput("blocks", "How many blocks (HEIGHT)?", min = 1, max = 10, value = 1), 
